					...
					<div className='row'>
						<div className='col-xl-6 col-lg-6 col-md-12 col-sm-12'>
							...
							<div className='stats-data'>
								...
								<span className='statsData'>{statsres.bestTrophies}</span>
							</div>

							<div className='stats-data'>
								<span className='statstext'>Trophies</span>
								<span className='stat-divider'></span>
								<span className='statsData'>{statsres.trophies}</span>
							</div>
							...
							<div className='stats-data'>
								...
								<span className='stat-divider'></span>
								<span className='statsData'>{statsres.wins}</span>
							</div>

							<div className='stats-data'>
								<span className='statstext'>Total Looses</span>
								<span className='stat-divider'></span>
								<span className='statsData'>{statsres.losses}</span>
							</div>

							<div className='stats-data'>
								<span className='statstext'>threeCrownWins</span>
								<span className='stat-divider'></span>
								<span className='statsData'>{statsres.threeCrownWins}</span>
							</div>

							<div className='stats-data'>
								<span className='statstext'>challengeMaxWins</span>
								<span className='stat-divider'></span>
								<span className='statsData'>{statsres.challengeMaxWins}</span>
							</div>

							<div className='stats-data'>
								<span className='statstext'>BattleCount</span>
								<span className='stat-divider'></span>
								<span className='statsData'>{statsres.battleCount}</span>
							</div>
							{/* end of first col */}
						</div>
						<div className='col-xl-6 col-lg-6 col-md-12 col-sm-12 data-holder '>
							<div className='d-flex stats-header text-wrap'>
								<span className='align-middle headerText'>
									<img
										src={clanWar}
										className='align-middle stat-icon'
										alt=''
									/>
									Clan War Stats
								</span>
							...
							<div className='stats-data'>
								...
								<span className='stat-divider'></span>
								<span className='statsData'>{statsres.warDayWins}</span>
							</div>
							<div className='stats-data'>
								<span className='statstext'>clanCardsCollected</span>
								<span className='stat-divider'></span>
								<span className='statsData'>{statsres.clanCardsCollected}</span>
							</div>
							<div className='stats-data'>
								<span className='statstext'>totalDonations</span>
								<span className='stat-divider'></span>
								<span className='statsData'>{statsres.totalDonations}</span>
							</div>
							...
							<div className='stats-data'>
								...
								<span className='stat-divider'></span>
								<span className='statsData'>{statsres.tournamentCardsWon}</span>
							</div>
							...
							<div className='stats-data'>
								...
								<span className='stat-divider'></span>
								<span className='statsData'>{statsres.challengeCardsWon}</span>
							</div>
