				...
				{!this.state.isLoading && (
					<div>
									...
									<div className='clan-props '>
										<div className='props-item d-block'>
											...
											<span className='text-monospace props-header text-wrap'>
												score
												<h6 className='props-value'>{clanData.clanScore}</h6>
											</span>
										</div>
										...
										<div className='props-item d-block'>
											...
											<span className='text-monospace props-header'>
												type
												<h6 className='props-value'>{clanData.type}</h6>
											</span>
										</div>
									</div>
								</div>
						...
						<div className='container-fluid'>
							<Member memberData={clanData.memberList} />
						</div>
					</div>
				)}
			</div>
