			...
			<div className='Homepage'>
				...
				<div className='App'>
					<div className='home'>
						...
						<label className='home_label2'>
							Access Player Data On FingureTouch...
						</label>
						<select
							className='home_select1'
							onChange={(e) => {
						...
						<Link
							to={`/${selectOp}`}
							className=' home_button1 text-center'
					...
					<div className='home_features row'>
						<div className='home_chest  col-md-4 col-xs-12 col-sm-12'>
							...
							<p className='feature_info'>
								Wondering when that Legendary chest is coming? We got you
								covered.
							</p>
						</div>
